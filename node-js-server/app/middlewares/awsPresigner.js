...
AWS.config = new AWS.Config({
  accessKeyId: config.S3_KEY, // stored in the .env file
  secretAccessKey: config.S3_SECRET, // stored in the .env file
  region: config.BUCKET_REGION // This refers to your bucket configuration.
});
